...
class Server(QWidget):
    ...
    def initUI(self):
        ...
        self.result_lbl.setText('000.00')
        self.result_lbl.resize(self.result_lbl.sizeHint())
        # 开始控件
    ...
    def start_measure(self):
        print("Welcome to Distance Server!")
    ...
    def play(self):
        print("=========Begin Playing Chrip Signal=========")
    ...
    def analysis(self):
        ...
        print("=========Calculate Time Delta=========")
        time_delta_server = (self.time_receive -self.time_send)/sample_rate
        print("time_delta_server: ", time_delta_server)
        # 获取client端时间差
        print("getting time_delta_client from http_server...")
        ...
        if num == 0:
            ...
            print("finished!")
            print("time_delta_client: ", time_delta_client)
            time_delta_client = float(time_delta_client)
            # 计算距离
            time_delta = time_delta_server - time_delta_client
            print("time_delta: ", time_delta)
            distance = 16227 * time_delta + 45.83
